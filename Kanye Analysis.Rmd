...
## Kanye West Personality Analysis
...
```{r Big 5, echo= FALSE}
Openness<- c(CollegeDropout_json_data$personality[[1]][4][[1]],
             LateRegistration_json_data$personality[[1]][4][[1]], 
             Graduation_json_data$personality[[1]][4][[1]],
             Heartbreak_json_data$personality[[1]][4][[1]],
             MBDTF_json_data$personality[[1]][4][[1]], Yeezus_json_data$personality[[1]][4][[1]], 
             TLOP_json_data$personality[[1]][4][[1]])

Conscientiousness<- c(CollegeDropout_json_data$personality[[2]][4][[1]],
                      LateRegistration_json_data$personality[[2]][4][[1]], 
                      Graduation_json_data$personality[[2]][4][[1]],
                      Heartbreak_json_data$personality[[2]][4][[1]],
                      MBDTF_json_data$personality[[2]][4][[1]],
                      Yeezus_json_data$personality[[2]][4][[1]], 
                      TLOP_json_data$personality[[2]][4][[1]])

Extraversion<- c(CollegeDropout_json_data$personality[[3]][4][[1]],
                 LateRegistration_json_data$personality[[3]][4][[1]], 
                 Graduation_json_data$personality[[3]][4][[1]],
                 Heartbreak_json_data$personality[[3]][4][[1]], 
                 MBDTF_json_data$personality[[3]][4][[1]], Yeezus_json_data$personality[[3]][4][[1]], 
                 TLOP_json_data$personality[[3]][4][[1]])


Agreeableness<- c(CollegeDropout_json_data$personality[[4]][4][[1]],
                  LateRegistration_json_data$personality[[4]][4][[1]], 
                  Graduation_json_data$personality[[4]][4][[1]],
                  Heartbreak_json_data$personality[[4]][4][[1]],
                  MBDTF_json_data$personality[[4]][4][[1]], Yeezus_json_data$personality[[4]][4][[1]], 
                  TLOP_json_data$personality[[4]][4][[1]])

Emotional_range<- c(CollegeDropout_json_data$personality[[5]][4][[1]],
                    LateRegistration_json_data$personality[[5]][4][[1]], 
                    Graduation_json_data$personality[[5]][4][[1]],
                    Heartbreak_json_data$personality[[5]][4][[1]],
...
Adventurousness<- c(CollegeDropout_json_data$personality[[1]][5][[1]][[1]][[4]], 
                    ...
                    MBDTF_json_data$personality[[1]][5][[1]][[1]][[4]],
                    Yeezus_json_data$personality[[1]][5][[1]][[1]][[4]], 
...
Artistic_Interest<- c(CollegeDropout_json_data$personality[[1]][5][[1]][[2]][[4]], 
                      ...
                      MBDTF_json_data$personality[[1]][5][[1]][[2]][[4]],
                      Yeezus_json_data$personality[[1]][5][[1]][[2]][[4]], 
...
Emotionality<- c(CollegeDropout_json_data$personality[[1]][5][[1]][[3]][[4]], 
                 ...
                 MBDTF_json_data$personality[[1]][5][[1]][[3]][[4]],
                 Yeezus_json_data$personality[[1]][5][[1]][[3]][[4]], 
...
Imagination<- c(CollegeDropout_json_data$personality[[1]][5][[1]][[4]][[4]], 
                ...
                MBDTF_json_data$personality[[1]][5][[1]][[4]][[4]],
                Yeezus_json_data$personality[[1]][5][[1]][[4]][[4]], 
...
Intellect<- c(CollegeDropout_json_data$personality[[1]][5][[1]][[5]][[4]], 
              ...
              MBDTF_json_data$personality[[1]][5][[1]][[5]][[4]],
              Yeezus_json_data$personality[[1]][5][[1]][[5]][[4]], 
...
Authority_Challenge<- c(CollegeDropout_json_data$personality[[1]][5][[1]][[6]][[4]], 
                        ...
                        MBDTF_json_data$personality[[1]][5][[1]][[6]][[4]],
                        Yeezus_json_data$personality[[1]][5][[1]][[6]][[4]], 
                        TLOP_json_data$personality[[1]][5][[1]][[6]][[4]])

Kanye_Openness1<- data.frame(Album_name, Adventurousness, Artistic_Interest, Emotionality)

Kanye_Openness1.long<- melt(Kanye_Openness1)

ggplot(Kanye_Openness1.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge")+ 
...
Kanye_Openness2<- data.frame(Album_name, Imagination, Intellect, Authority_Challenge)

Kanye_Openness2.long<- melt(Kanye_Openness2)

ggplot(Kanye_Openness2.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge")+ 
  labs(title="Kanye's Openness", fill= "Album", x= "Openness Facets", y= "Percentile Rank")
```
...
Achievement_Striving<- c(CollegeDropout_json_data$personality[[2]][5][[1]][[1]][[4]], 
                         ...
                         MBDTF_json_data$personality[[2]][5][[1]][[1]][[4]],
                         Yeezus_json_data$personality[[2]][5][[1]][[1]][[4]], 
...
Cautiousness<- c(CollegeDropout_json_data$personality[[2]][5][[1]][[2]][[4]], 
                  ...
                  MBDTF_json_data$personality[[2]][5][[1]][[2]][[4]],
                  Yeezus_json_data$personality[[2]][5][[1]][[2]][[4]], 
...
Dutifulness<- c(CollegeDropout_json_data$personality[[2]][5][[1]][[3]][[4]], 
                ...
                MBDTF_json_data$personality[[2]][5][[1]][[3]][[4]],
                Yeezus_json_data$personality[[2]][5][[1]][[3]][[4]], 
...
Orderliness<- c(CollegeDropout_json_data$personality[[2]][5][[1]][[4]][[4]], 
                ...
                MBDTF_json_data$personality[[2]][5][[1]][[4]][[4]],
                Yeezus_json_data$personality[[2]][5][[1]][[4]][[4]], 
...
Self_Discipline<- c(CollegeDropout_json_data$personality[[2]][5][[1]][[5]][[4]], 
                    ...
                    MBDTF_json_data$personality[[2]][5][[1]][[5]][[4]],
                    Yeezus_json_data$personality[[2]][5][[1]][[5]][[4]], 
...
Self_Efficacy<- c(CollegeDropout_json_data$personality[[2]][5][[1]][[6]][[4]], 
                  ...
                  MBDTF_json_data$personality[[2]][5][[1]][[6]][[4]],
                  Yeezus_json_data$personality[[2]][5][[1]][[6]][[4]], 
                  TLOP_json_data$personality[[2]][5][[1]][[6]][[4]])

Kanye_Conscientiousness1<- data.frame(Album_name, Achievement_Striving, Cautiousness, Dutifulness)

Kanye_Conscientiousness1.long<- melt(Kanye_Conscientiousness1)

ggplot(Kanye_Conscientiousness1.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge")+ 
...
Kanye_Conscientiousness2<- data.frame(Album_name, Orderliness, Self_Discipline, Self_Efficacy)

Kanye_Conscientiousness2.long<- melt(Kanye_Conscientiousness2)

ggplot(Kanye_Conscientiousness2.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge")+ 
  labs(title="Kanye's Conscientiousness", fill= "Album", x= "Conscientiousness Facets", y= "Percentile Rank")
```
...
Activity<- c(CollegeDropout_json_data$personality[[3]][5][[1]][[1]][[4]], 
             ...
             MBDTF_json_data$personality[[3]][5][[1]][[1]][[4]],
             Yeezus_json_data$personality[[3]][5][[1]][[1]][[4]], 
...
Assertive<- c(CollegeDropout_json_data$personality[[3]][5][[1]][[2]][[4]], 
              ...
              MBDTF_json_data$personality[[3]][5][[1]][[2]][[4]],
              Yeezus_json_data$personality[[3]][5][[1]][[2]][[4]], 
...
Cheerful<- c(CollegeDropout_json_data$personality[[3]][5][[1]][[3]][[4]], 
             ...
             MBDTF_json_data$personality[[3]][5][[1]][[3]][[4]],
             Yeezus_json_data$personality[[3]][5][[1]][[3]][[4]], 
...
Thrill_Seeking<- c(CollegeDropout_json_data$personality[[3]][5][[1]][[4]][[4]], 
                   ...
                   MBDTF_json_data$personality[[3]][5][[1]][[4]][[4]],
                   Yeezus_json_data$personality[[3]][5][[1]][[4]][[4]], 
...
Warmth<- c(CollegeDropout_json_data$personality[[3]][5][[1]][[5]][[4]], 
             ...
             MBDTF_json_data$personality[[3]][5][[1]][[5]][[4]],
             Yeezus_json_data$personality[[3]][5][[1]][[5]][[4]], 
...
Gregariousness<- c(CollegeDropout_json_data$personality[[3]][5][[1]][[6]][[4]], 
                   ...
                   MBDTF_json_data$personality[[3]][5][[1]][[6]][[4]],
                   Yeezus_json_data$personality[[3]][5][[1]][[6]][[4]], 
                   TLOP_json_data$personality[[3]][5][[1]][[6]][[4]])


Kanye_Extraversion1<- data.frame(Album_name, Activity, Assertive, Cheerful)

Kanye_Extraversion1.long<- melt(Kanye_Extraversion1)

ggplot(Kanye_Extraversion1.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge") + 
...
Kanye_Extraversion2<- data.frame(Album_name, Thrill_Seeking, Warmth, Gregariousness)

Kanye_Extraversion2.long<- melt(Kanye_Extraversion2)

ggplot(Kanye_Extraversion2.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge") + 
  labs(title="Kanye's Extraversion", fill= "Album", x= "Extraversion Facets", y= "Percentile Rank")
```
...
Altruism<- c(CollegeDropout_json_data$personality[[4]][5][[1]][[1]][[4]], 
             ...
             MBDTF_json_data$personality[[4]][5][[1]][[1]][[4]],
             Yeezus_json_data$personality[[4]][5][[1]][[1]][[4]], 
...
Cooperation<- c(CollegeDropout_json_data$personality[[4]][5][[1]][[2]][[4]], 
                ...
                MBDTF_json_data$personality[[4]][5][[1]][[2]][[4]],
                Yeezus_json_data$personality[[4]][5][[1]][[2]][[4]], 
...
Modesty<- c(CollegeDropout_json_data$personality[[4]][5][[1]][[3]][[4]], 
            ...
            MBDTF_json_data$personality[[4]][5][[1]][[3]][[4]],
            Yeezus_json_data$personality[[4]][5][[1]][[3]][[4]], 
...
Uncomprimising<- c(CollegeDropout_json_data$personality[[4]][5][[1]][[4]][[4]], 
                    ...
                    MBDTF_json_data$personality[[4]][5][[1]][[4]][[4]],
                    Yeezus_json_data$personality[[4]][5][[1]][[4]][[4]], 
...
Sympathy<- c(CollegeDropout_json_data$personality[[4]][5][[1]][[5]][[4]], 
             ...
             MBDTF_json_data$personality[[4]][5][[1]][[5]][[4]],
             Yeezus_json_data$personality[[4]][5][[1]][[5]][[4]], 
...
Trust<- c(CollegeDropout_json_data$personality[[4]][5][[1]][[6]][[4]], 
          ...
          MBDTF_json_data$personality[[4]][5][[1]][[6]][[4]],
          Yeezus_json_data$personality[[4]][5][[1]][[6]][[4]], 
...
Kanye_Agreeableness2<- data.frame(Album_name, Uncomprimising, Sympathy, Trust)

Kanye_Agreeableness2.long<- melt(Kanye_Agreeableness2)

ggplot(Kanye_Agreeableness2.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge")+ 
  labs(title="Kanye's Agreeableness", fill= "Album", x= "Agreeableness Facets", y= "Percentile Rank")
```

**Uncomprimising** - Kanye and genuine in expression; candid, blunt.
...
Fiery<- c(CollegeDropout_json_data$personality[[5]][5][[1]][[1]][[4]], 
          ...
          MBDTF_json_data$personality[[5]][5][[1]][[1]][[4]],
          Yeezus_json_data$personality[[5]][5][[1]][[1]][[4]], 
...
Worry_Prone<- c(CollegeDropout_json_data$personality[[5]][5][[1]][[2]][[4]], 
                ...
                MBDTF_json_data$personality[[5]][5][[1]][[2]][[4]], 
                Yeezus_json_data$personality[[5]][5][[1]][[2]][[4]], 
...
Melancholy<- c(CollegeDropout_json_data$personality[[5]][5][[1]][[3]][[4]], 
                ...
                MBDTF_json_data$personality[[5]][5][[1]][[3]][[4]],
                Yeezus_json_data$personality[[5]][5][[1]][[3]][[4]], 
...
Immoderation<- c(CollegeDropout_json_data$personality[[5]][5][[1]][[4]][[4]], 
                 ...
                 MBDTF_json_data$personality[[5]][5][[1]][[4]][[4]],
                 Yeezus_json_data$personality[[5]][5][[1]][[4]][[4]], 
...
Self_Conscious<- c(CollegeDropout_json_data$personality[[5]][5][[1]][[5]][[4]], 
                   ...
                   MBDTF_json_data$personality[[5]][5][[1]][[5]][[4]],
                   Yeezus_json_data$personality[[5]][5][[1]][[5]][[4]], 
...
Stress<- c(CollegeDropout_json_data$personality[[5]][5][[1]][[6]][[4]], 
           ...
           MBDTF_json_data$personality[[5]][5][[1]][[6]][[4]],
           Yeezus_json_data$personality[[4]][5][[1]][[6]][[4]], 
           TLOP_json_data$personality[[5]][5][[1]][[6]][[4]])

Kanye_Neuroticism1<- data.frame(Album_name, Fiery, Worry_Prone, Melancholy)

Kanye_Neuroticism1.long<- melt(Kanye_Neuroticism1)

ggplot(Kanye_Neuroticism1.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge") + 
...
Kanye_Neuroticism2<- data.frame(Album_name, Immoderation, Self_Conscious, Stress)

Kanye_Neuroticism2.long<- melt(Kanye_Neuroticism2)

ggplot(Kanye_Neuroticism2.long,aes(variable,value,fill=Album_name))+
  geom_bar(stat="identity",position="dodge") + 
  labs(title="Kanye's Emotional Range", fill= "Album", x= "Emotional Range Facets", y= "Percentile Rank")
```

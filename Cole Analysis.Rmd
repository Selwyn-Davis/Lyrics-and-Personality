...
Album_name= c("The Warm Up", "The Sideline Story", "Born Sinner", "2014 Forest Hills Drive", "4 Your Eyez Only", "KOD")
...
ggplot(Cole.long,aes(variable,value,fill=Album_name))+
  ...
  labs(title="Cole's Big 5 Traits", fill= "Album", x= "Personality Traits", y= "Percentile Rank")+scale_x_discrete()
```
...
Outgoing<- c(TheWarmUp_json_data$personality[[3]][5][[1]][[5]][[4]], 
...
Self_Consciousness<- c(TheWarmUp_json_data$personality[[5]][5][[1]][[5]][[4]], 
